...
public class GL31 : GL30
{
	...
	/// <summary>
	/// Accepted by the <c>target</c> parameter of BindBuffer, BufferData, BufferSubData, MapBuffer, MapBufferRange, BindTexture, UnmapBuffer, GetBufferSubData, GetBufferParameteriv, GetBufferPointerv, and TexBuffer, and the <c>pname</c> parameter of GetBooleanv, GetDoublev, GetFloatv, and GetIntegerv.
	/// </summary>
	...
	/// <summary>
	/// Accepted by the <c>cap</c> parameter of Enable, Disable and IsEnabled; by the <c>pname</c> parameter of GetBooleanv, GetIntegerv, GetFloatv and GetDoublev; and by the <c>target</c> parameter of BindTexture, GetTexParameterfv, GetTexParameteriv, TexParameterf, TexParameteri, TexParameterfv and TexParameteriv.
	/// </summary>
	...
	/// <summary>
	/// Returned by <c>type</c> parameter of GetActiveUniform when the location <c>index</c> for program object <c>program</c> is of type sampler2DRect.
	/// </summary>
	public const int SAMPLER_2D_RECT = 0x8B63;

	/// <summary>
	/// Returned by <c>type</c> parameter of GetActiveUniform when the location <c>index</c> for program object <c>program</c> is of type sampler2DRectShadow.
	/// </summary>
	public const int SAMPLER_2D_RECT_SHADOW = 0x8B64;

	/// <summary>
	/// Accepted by the <c>target</c> parameters of BindBuffer, BufferData, BufferSubData, MapBuffer, UnmapBuffer, GetBufferSubData, and GetBufferPointerv.
	/// </summary>
