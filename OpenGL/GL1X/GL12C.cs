/// <summary>
/// The OpenGL functionality of a forward compatible context, up to version 1.2.<br/>
...
public class GL12C : GL11C
{
    ...
    /// <summary>
    /// Accepted by the <c>pname</c> parameter of GetBooleanv, GetIntegerv, GetFloatv, and GetDoublev, and by the
    /// <c>pname</c> parameter of PixelStore.
    /// </summary>
    public const int
    ...
    /// <summary>
    /// Accepted by the <c>type</c> parameter of DrawPixels, ReadPixels, TexImage1D, TexImage2D, GetTexImage,
    /// TexImage3D, TexSubImage1D, TexSubImage2D, TexSubImage3D, GetHistogram, GetMinmax, ConvolutionFilter1D,
    /// ConvolutionFilter2D, ConvolutionFilter3D, GetConvolutionFilter, SeparableFilter2D, SeparableFilter3D,
