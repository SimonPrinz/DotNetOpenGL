/// <summary>
/// The OpenGL functionality up to version 2.0. Includes the deprecated symbols of the Compatibility Profile.<br/>
...
public class GL20 : GL15
{
    ...
    /// GetBooleanv, GetIntegerv, GetFloatv, and GetDoublev, and by the <c>target</c> parameter of TexEnvi, TexEnviv,
    /// TexEnvf, TexEnvfv, GetTexEnviv, and GetTexEnvfv.
    /// </summary>
    public const int POINT_SPRITE = 0x8861;

    /// <summary>
    /// When the <c>target</c> parameter of TexEnvf, TexEnvfv, TexEnvi, TexEnviv, GetTexEnvfv, or GetTexEnviv is
    /// POINT_SPRITE, then the value of <c>pname</c> may be.
    /// </summary>
